...
//        return $this->filteredPatient($request);
    ...
    public function savePatient(Request $request)
    {
        ...
        $sender_message=auth()->user()->name."You have successfully registered new Patient called :"." ".$patient->name." ".$patient->email." From ".$patient->address." "." in the ITHS system";
        $receiver_message=$patient->name.""."Your Patient new account has been created successfully in the ITHS system";
           
        $adse='0788237148';
        $sms=new TransferSms();
    $sms->sendSMS($adse,$sender_message);
    $sms->sendSMS($request->get('phone'),$receiver_message);
