    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <a href="{{url('/all-schedule')}}" class="btn btn-success pull-right">All DoctorsDoctor</a>
                ...
                <form action="#" method="post" id="newSchedule">
                    ...
                    <div class="form-group-custom">
                        ...
                        <label class="control-label">Doctor (please indicate his or her speciality and his or her hospital) &nbsp;*</label><i class="bar"></i>
                    </div>
                    <div class="form-group-custom">
