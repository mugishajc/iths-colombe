    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <a href="{{url('/all-schedule')}}" class="btn btn-success pull-right">All Doctor</a>
                <h4 class="card-title">Edit Doctor - {{$schedule->name}}</h4>
                <form action="#" method="post" id="updateSchedule">
                    {{csrf_field()}}
                    <div class="form-group-custom">
                        <input type="text" name="name" value="{{$schedule->name}}" required="required" autofocus/>
                        <label class="control-label">Doctor &nbsp;*</label><i class="bar"></i>
                    </div>
                    <div class="form-group-custom">
