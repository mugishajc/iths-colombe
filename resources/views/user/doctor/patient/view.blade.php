        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4>Payment Info <a style="font-size: 15px;" href="javascript:void(0);" onclick="window.location.replace('{{url('/take-patient-to-appointment/'.$patient->id)}}')" class="pull-right"> <i class="ti ti-calendar"></i> Make an transfer</a> </h4>
                        <ul class="list-group">
