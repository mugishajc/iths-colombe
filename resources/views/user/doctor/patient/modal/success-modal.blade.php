        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    ...
                    <p id="modalPatientPhone">Phone : 0782016513</p>
                </center>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Close</button>
                <button type="button" id="modalBtnMakeAppointment" class="btn btn-success waves-effect waves-light">Make Urgent Transfer</button>
