    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="text-muted menu-title">Assistant Activities</li>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="ti-calendar"></i> <span> Transfer</span> <span class="menu-arrow"></span> </a>
                    <ul class="list-unstyled">
                        <li><a href="{{url('/new-appointment')}}">New Transfer</a></li>
                        <li><a href="{{url('/all-appointment')}}">All Transfer</a></li>
                        <li><a href="{{url('/appointment-today')}}">Today's Transfers</a></li>
                    </ul>
                </li>
