...
<div class="left side-menu b-gradient-dark ">
    <div class="sidebar-inner slimscrollleft">
        <!--- Divider -->
        <div id="sidebar-menu">
            <ul>

                <li class="text-muted menu-title">Admin Activities</li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{url('/new-appointment')}}">New Transfer</a></li>
                        <li><a href="{{url('/all-appointment')}}">All Transfer</a></li>
                        <li><a href="{{url('/appointment-today')}}">Transfers of Today</a></li>
                    </ul>
                </li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{url('/schedule-report/schedule=0/start=2017-06-05/end='.$date_today)}}">Doctor Report</a></li>
                    </ul>
                </li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{url('/all-schedule')}}">Doctor Setting</a></li>
